...
RepeatMasker -species Lepidosauria -s -gff -dir /g/data/te53/zc4688/honours/analyses/cn/pogvit /g/data/xl04/genomeprojects/Pogona_vitticeps/analysis/ribocop/POGVIT.rDNA.refmorph.fasta 

grep -v "rRNA" POGVIT.rDNA.refmorph.fasta.out.gff | tail -n +3| awk '{print $1"\t"($4-1)"\t"$5}'  > masking.bed
    
bedtools maskfasta -fi /g/data/xl04/genomeprojects/Pogona_vitticeps/analysis/ribocop/POGVIT.rDNA.refmorph.fasta -bed masking.bed -fo masked.fasta -mc N
...
bwa-mem2 mem -a -t24 -T18 -h2 -k 10 /g/data/xl04/genomeprojects/Pogona_vitticeps/fasta/POGVIT.v2.1.fasta named.fa > testbwa.sam


samtools view -b testbwa.sam > testbwa.bam

cut -f1,3,4 /g/data/xl04/genomeprojects/Pogona_vitticeps/analysis/ribocop/POGVIT.rdnaregions.bed > rdnaregions.bed # manually collapsed regions on same scaffold and added a bit to either side of scaffold 2
